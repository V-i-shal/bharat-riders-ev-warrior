  ...
  return (
    <div style={{ backgroundColor: '#0a0a0a', minHeight: '100vh', paddingBottom: '40px' }}>
      ...
      <div style={{
        ...
        {step === 1 && <FormSectionA onNext={handleNext} t={t} defaultValues={formData} />}
        {step === 2 && <FormSectionB onNext={handleNext} onBack={handleBack} t={t} defaultValues={formData} />}
        {step === 3 && <FormSectionC onNext={handleNext} onBack={handleBack} defaultValues={formData} />}
        {step === 4 && <FormSectionD onNext={handleNext} onBack={handleBack} defaultValues={formData} />}
        {step === 5 && <FormSectionE onNext={handleNext} onBack={handleBack} defaultValues={formData} />}
        {step === 6 && <FormSectionF onSubmit={handleSubmit} onBack={handleBack} defaultValues={formData} />}
      </div>
    </div>
  )
}